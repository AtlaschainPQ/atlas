/* @ts-self-types="./atlas_wallet_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function account_from_mnemonic(phrase) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.account_from_mnemonic(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function account_from_secret(secret_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(secret_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.account_from_secret(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @param {string} fee
 * @param {bigint} nonce
 * @param {bigint} sender_index
 * @returns {string}
 */
export function build_forced_tx(secret_hex, to_hex, amount, fee, nonce, sender_index) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(secret_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(to_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ret = wasm.build_forced_tx(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, nonce, sender_index);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
 ...
 * @returns {string}
 */
export function build_submit_tx(secret_hex, to_hex, amount, fee, nonce) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(secret_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr3 = passStringToWasm0(fee, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.build_submit_tx(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, nonce);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
...
export function generate_account() {
    ...
    let deferred2_1;
    try {
        const ret = wasm.generate_account();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./atlas_wallet_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('atlas_wallet_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
